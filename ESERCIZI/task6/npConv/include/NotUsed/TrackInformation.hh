...
class TrackInformation : public G4VUserTrackInformation 
{
  ...
  G4double              originalZPosition;
  G4ThreeVector         originalMomentum;
  G4double              originalEnergy;
  G4double              originalTime;
  G4String              originalTrackName; 
  G4int                 originalPDGEncoding;
  ...
  public:
    ...
    inline G4double GetOriginalZPosition() const {return originalZPosition;}
    inline G4String GetOriginalTrackName() const {return originalTrackName;}
    inline G4int    GetOriginalPDGEncoding() const {return originalPDGEncoding;}
