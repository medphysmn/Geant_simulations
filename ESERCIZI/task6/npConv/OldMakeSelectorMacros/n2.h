...
// Tue Mar 30 11:28:35 2010 by ROOT version 5.26/00
...
public :
   ...
   Float_t         zp[1000];   //[ntracks]
   Float_t         t[1000];   //[ntracks]
   Int_t           evid;
...
string n2::convertInt(Int_t number)
     
{
  ...
  else if(number == 1000070140)
    {
      tmps = "N14";
    }
  
  else if(number == 1000280620)
    {
      tmps = "Ni62";
    }

  else if(number == 1000050110)
    {
      tmps = "B11";
    }

  else if(number == 1000270600)
    {
      tmps = "Co60";
    }

  else if(number == 1000060150 )
    {
      tmps = "C15";
    }

  else if(number == 1000280650)
    {
      tmps = "Ni65";
    }
  
  else if(number == 1000010030)
    {
      tmps = "H3";
    }
  else if(number== 1000060140)
    {
      tmps = "C14";
    }
  ...
  else if(number== 1000070150)
    {
      tmps = "N15";
    }

  else if(number== 1000280640)
    {
      tmps = "Ni64";
    }
