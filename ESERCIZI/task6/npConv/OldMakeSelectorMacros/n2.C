#define n2_cxx
// The class definition in n2.h has been generated automatically
...
//
// Root > T->Process("n2.C")
// Root > T->Process("n2.C","some options")
// Root > T->Process("n2.C+")
//
...
Bool_t n2::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either n2::GetEntry() or TBranch::GetEntry()
