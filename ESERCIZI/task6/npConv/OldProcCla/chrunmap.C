#define chrunmap_cxx
// The class definition in chrunmap.h has been generated automatically
...
//
// Root > T->Process("chrunmap.C")
// Root > T->Process("chrunmap.C","some options")
// Root > T->Process("chrunmap.C+")
//
...
void chrunmap::Begin(TTree * /*tree*/)
{
...
void chrunmap::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t chrunmap::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either chrunmap::GetEntry() or TBranch::GetEntry()
